...
raw_data <- read_excel("output_files/data/3a_CLR_data.xlsx")
```
...
#new <- event_data %>% 
#  select(-c(Healing_time, Healing, avg_TBI, ID_Nr, event_all)) %>% 
#  as.data.frame()
...
if(save.data) write.xlsx(as.data.frame(results_cox_adjusted), 
                         "output_files/data/3b_cox_adjusted.xlsx", 
                         row.names = FALSE)
...
if(save.data) write.xlsx(as.data.frame(uniprot_names), 
                         "output_files/data/3b_cox_adjusted_uniprotnames.xlsx", 
                         row.names = FALSE)
...
corrplot(M,, method="color", tl.cex=0.5,  order="hclust") #, tl.pos='n'
heatmap(M, col = terrain.colors(256))
```
```{r corrplot}
require("corrplot")
corplot_list <- results_cox_filtered$term
...
M<-cor(corplot_data, method = "spearman")
M <- M[-which(is.na(rownames(M))), -which(is.na(colnames(M)))]

#corrplot(M, method="color",  order="hclust")
png("output_files/figures/3b/3b_corr_proteins.png", width=7.5, height=7.5, units = "in", res = 300)
gplots::heatmap.2(M,
                  revC = TRUE,
                  trace = "none",
                  density.info = "none",
...
M_fin <- M[covariates,!(colnames(M) %in% covariates)]

png("output_files/figures/3b/3b_corr_covariates.png", width=7.5, height=4.5, units = "in", res = 300)
...
if(save.plots) ggsave(plot, 
                      filename = "output_files/figures/3b/volcano_plot.png",
                      width = 10, 
                      height = 7, 
                      device='tiff', 
                      dpi=700)
...
ggsave(plot,
       filename = "output_files/figures/3b/3b_volcano_plot.png",
       width = 7.5, 
       height = 4.5)
```
...
if(save.data) sink("output_files/figures/3b/fit_summary_all.txt")
...
if(save.plots) ggsave(plot, 
                      filename = "output_files/figures/3b/KM_curve_all.png",
                      width = 10, 
                      height = 10, 
                      device='tiff', 
                      dpi=700)
...
if(save.data) sink("output_files/figures/3b/fit_summary_Dtype.txt")
print(summary(fit, times = c(1,5*(1:40))))
cat("\n")
...
if(save.plots) ggsave(file = "output_files/figures/3b/KM_curve_Dtype.png",
                      plot,
                      width = 10,
                      height = 10,
                      device='tiff',
...
if(save.data) sink("output_files/figures/3b/fit_summary_gender.txt")
print(summary(fit, times = c(1,5*(1:40))))
cat("\n")
...
if(save.plots) ggsave(file = "output_files/figures/3b/KM_curve_gender.png",
                      plot,
                      width = 10,
                      height = 10,
                      device='tiff',
...
if(save.data) sink("output_files/figures/3b/fit_summary_Dduration.txt")
...
if(save.plots)ggsave(file = "output_files/figures/3b/KM_curve_Dduration.png",
                      plot,
                      width = 10,
                      height = 7,
                      device='tiff',
...
if(save.data) sink("output_files/figures/3b/fit_summary_bmi.txt")
...
if(save.plots) ggsave(file = "output_files/figures/3b/KM_curve_bmi.png",
                      plot,
                      width = 10,
                      height = 7,
                      device='tiff',
...
if(save.data) sink("output_files/figures/3b/fit_summary_age.txt")
...
if(save.plots) ggsave(file = "output_files/figures/3b/KM_curve_age.png",
                      plot,
                      width = 10,
                      height = 7,
                      device='tiff',
...
if(save.data) sink("output_files/figures/3b/fit_summary_HBA1C.txt")
...
if(save.plots) ggsave(file = "output_files/figures/3b/KM_curve_HBA1C.png",
                      plot,
                      width = 10,
                      height = 7,
                      device='tiff',
...
if(save.data) sink("output_files/figures/3b/fit_summary_triglycerides.txt")
...
if(save.plots) ggsave(file = "output_files/figures/3b/KM_curve_triglycerides.png",
                      plot,
                      width = 10,
                      height = 7,
                      device='tiff',
...
for (i in 1:nrow(results_cox_filtered)) {
  ...
  if(save.data) sink(paste0("output_files/figures/3b/fit_summary_", 
  ...
  if(save.plots) ggsave(file = paste0("output_files/figures/3b/3b_KM_curve_", 
