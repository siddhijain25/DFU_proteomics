...
if(save.plots)  ggsave(filename = paste0("output_files/figures/1a/2_boxplot_healing_simulated.png"),
                        plot,
                        width = 10, 
                        height = 7, 
                        device='tiff', 
...
# Correlation plot for proteins vs proteins
...
```
```{r}
# Correlation plot for proteins vs covariates
